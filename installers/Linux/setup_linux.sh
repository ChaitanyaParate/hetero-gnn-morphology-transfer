...
if [ ! -f "${SCRIPT_DIR}/${TAR_FILE}" ]; then
    ...
    echo -e "       ${SCRIPT_DIR}"
    echo -e ""
    echo -e "${YELLOW}  Download it from Zenodo (permanent DOI, 8.3 GB):${NC}"
    echo -e "  https://zenodo.org/records/20187567/files/hetero_gnn_project.tar"
    echo -e "  DOI: https://doi.org/10.5281/zenodo.20187567"
    echo -e ""
    echo -e "${YELLOW}  Alternative (Google Drive):${NC}"
    echo -e "  https://drive.google.com/file/d/1tI2VpsGHoFGOhWkKnZxwH05tAVnjoXd5/view?usp=sharing"
    echo -e ""
    echo -e "${CYAN}  Or via terminal:${NC}"
    echo -e "    wget \"https://zenodo.org/records/20187567/files/hetero_gnn_project.tar\""
    echo -e "    # or via gdown:"
